    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                   <i><g:link class="fa fa-dashboard" controller="Servicios" action="index" >  <span>inicio</span></g:link>
                </li>
      ...
      <tbody>
          <tr> 
              ...
              <td><span class="text-ellipsis">  
                  <g:link class="fa fa-check text-success text-active" controller="Servicios" action="hacerservicio" id="${serv.id}"></g:link>
                  </span></td>
         </tr>
       </tbody>
    </table>
